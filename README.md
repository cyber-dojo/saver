...
* [POST kata_file_create(id,index,files,filename)](docs/api.md#post-kata_file_createidindexfilesfilename)
* [POST kata_file_delete(id,index,files,filename)](docs/api.md#post-kata_file_deleteidindexfilesfilename)
* [POST kata_file_rename(id,index,files,old_filename,new_filename)](docs/api.md#post-kata_file_renameidindexfilesold_filenamew_filename)
* [POST kata_file_edit(id,index,files)](docs/api.md#post-kata_file_editidindexfiles)
